...
if(!function_exists('qode_woocommerce_options_map')) {
	...
	function qode_woocommerce_options_map()
	{
		...
		$default_woo_features_container = qode_add_admin_container(
            array(
		...
		qode_add_admin_field(
			...
			array(
                ...
                'type'              => 'yesno',
                'label'             => esc_html__('Enable Default WooCommerce Product Gallery Features', 'qode'),
                'description'       => esc_html__('Enabling this option will add support for WooCommerce default zoom, swipe and lightbox features', 'qode'),
                'default_value'     => 'no',
