    ...
    <div class="qode-post-content">
        ...
        <div class="qode-post-text">
            <div class="qode-post-text-inner">
                <div class="qode-post-mark">
                    <span class="icon_quotations qode-quote-mark"></span>
                </div>
                ...
                <div class="qode-post-text-main">
					<?php echo qode_news_get_blog_part($blog_single_type.'/parts/post-type/quote','single', '', $params); ?>
